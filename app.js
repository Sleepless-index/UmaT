...
function TrendsTab({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, races.map((_, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        flex: 1,
        textAlign: "center",
...
function RacesTab({
  ...
  return /*#__PURE__*/React.createElement("div", null, races.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, winCount), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: C.muted,
      textTransform: "uppercase",
  ...
  }, lossCount), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: C.muted,
      textTransform: "uppercase",
  ...
  }, races.length, " race", races.length !== 1 ? "s" : "", " recorded"), races.length > 0 && /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setEditMode(e => !e);
      setConfirm(null);
    },
    ...
    name: "pencil",
    size: 13
  }), " ", editMode ? "Done" : "Edit")), races.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "anim-fade",
    style: {
      textAlign: "center",
      padding: "48px 20px"
  ...
  }, "No races yet"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: C.muted,
      marginTop: 4
    }
  }, "Tap + to add your first race")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8
    }
  }, pageRaces.map((race, pi) => {
    const i = pageStart + pi;
    const isConfirm = confirm === race.id;
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, race.label), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9,
        fontWeight: 800,
        padding: "2px 6px",
    ...
    }, isWin ? "Win" : "Loss")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: C.muted,
        display: "flex",
    ...
    }, totalPts.toLocaleString()), /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.muted
      }
    }, "total pts"))), /*#__PURE__*/React.createElement("button", {
      onClick: () => onView(race),
      title: "View",
      className: "tap",
      style: {
      ...
      style: {
        ...
        borderColor: isConfirm ? "#ef4444" : C.border2,
        color: isConfirm ? "#fff" : C.muted,
        fontSize: 11,
        fontWeight: 700
      }
    }, isConfirm ? "Sure?" : /*#__PURE__*/React.createElement(Icon, {
      name: "trash",
      size: 14
    }))));
    ...
    style: {
      ...
      background: C.faint,
      border: `1px solid ${C.border2}`,
      color: safePage === 0 ? C.border2 : C.muted,
    ...
    length: pageCount
  }, (_, p) => p).map(p => /*#__PURE__*/React.createElement("button", {
    key: p,
    onClick: () => goPage(p),
    className: "tap",
    style: {
      ...
      padding: "0 8px",
      borderRadius: 8,
      background: p === safePage ? C.accent : C.faint,
      border: `1px solid ${p === safePage ? C.accent : C.border2}`,
    ...
    style: {
      ...
      background: C.faint,
      border: `1px solid ${C.border2}`,
      color: safePage === pageCount - 1 ? C.border2 : C.muted,
